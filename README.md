# JSopX™ RCLxComponents Core Project
### from the ﻿jSilvestri.com BETA v 2024 the JSopX™ Open Project EXperiences Collection: 

### Phase 1 of 4
Create the initial `JSopX.RCLxComponents` Project (the RCLxComponents Razor Class Library). 

## Overview
The `JSopX.RCLxComponents` Project (the RCLxComponents Razor Class Library) which leverages the same Components, components & Web API all other projects in the JSopX™ Open Project EXperiences collection, and is the official RCLxComponents Project Example of the Enterprise-Level, Multi-Platform, Multi-Stack Application. 

### Prerequisites

The `JSopX.RCLxComponents` Project requires at least the following technologies to run as expected.
...
There are additional project resources from the [jSilvestri.com BETA v 2024 JSopX™ Open ProjectX Collection](https://github.com/JasonSilvestri/JSopX.OpenProjectX.git) that required in order for the The `JSopX.RCLxComponents` Project to run as expected. 
...
2. **Open the solution in Visual Studio**:
    ...
    - Open `JSopX.RCLxComponents.sln` in Visual Studio.
